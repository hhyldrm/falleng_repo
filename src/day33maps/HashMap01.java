...
public class HashMap01 {
	...
	public static void main(String[] args) {
		...
		//According to Java "Java" and "Java." are different words ut in our task they should be same
		//Because od that I need to remove all punctuation
		
		//"to" and "To" are different for Java but in may task they should be same
