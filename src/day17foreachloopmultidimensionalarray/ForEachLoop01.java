...
public class ForEachLoop01 {
	...
	public static void main(String[] args) {
		//1.Example: Find the vowels in a Sting by using arrays
		...
		for(String w : chars) {
			if(w.equalsIgnoreCase("a") || w.equalsIgnoreCase("e") || w.equalsIgnoreCase("o") || w.equalsIgnoreCase("o") || w.equalsIgnoreCase("i") ) {
				System.out.print(w + " ");//e a a a e a o e
				
			}
	
		}
		//2.Exaple: Print the words ending with "n"
		...
		System.out.println("Enter an integer...");//1234
		String n = scan.next();
