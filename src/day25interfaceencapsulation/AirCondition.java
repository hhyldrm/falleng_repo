...
1)Interface is not a class, interface is interface
	...
	5)All methods are “abstract” as default in an interface, because of that using
	...
	11) In different parent interfaces, you can create variables with the same name, it will not be problem because every time
		 when you call a variable you have to use interfaces
	...
	14)Concrete Class ==> Interface : implements
	   ...
	   interfaces==>Concrete Class : This is not allowed i Java, class cannot be parent of an interface
	   interfaces==>Abstract Class : This is not allowed i Java, class cannot be parent of an interface
...
*/
public interface AirCondition extends Vechile {
	
	String MAKE = "Samsung"; //10.madde
